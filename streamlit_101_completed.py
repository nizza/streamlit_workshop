...
# Title of the app
st.header('🚢 Titanic Surival Rate Analysis App')
...
try:
   ...
   ### Data Visualization
   st.subheader("Visualization - broken down by Survivor Rate")
  
   # Variable selection from table columns
   var = st.selectbox("Select variable to visualize", options=df.columns)
   ...
   if df[var].dtype in ['float64', 'int64']:
       ...
       sns.histplot(data=df, x=var, hue='survived', ax=axs[0])
